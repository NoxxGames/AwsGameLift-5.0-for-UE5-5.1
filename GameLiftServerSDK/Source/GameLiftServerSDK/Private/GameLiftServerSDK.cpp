...
FGameLiftGenericOutcome FGameLiftServerSDKModule::InitSDK(const Aws::GameLift::Server::Model::ServerParameters &serverParameters) {
#if WITH_GAMELIFT
    auto initSDKOutcome = Aws::GameLift::Server::InitSDK(serverParameters);
