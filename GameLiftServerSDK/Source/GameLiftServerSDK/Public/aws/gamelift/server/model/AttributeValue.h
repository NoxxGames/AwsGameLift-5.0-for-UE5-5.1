...
#else
public:
    explicit AttributeValue(AttrType attrType) : m_N(0), m_SLCount(0), m_SDMCount(0), m_attrType(attrType)
    {
        m_S[0] = '\0';
    }

    AttributeValue() : m_N(0), m_SLCount(0), m_SDMCount(0), m_attrType(AttrType::NONE)
    {
        m_S[0] = '\0';
    }
