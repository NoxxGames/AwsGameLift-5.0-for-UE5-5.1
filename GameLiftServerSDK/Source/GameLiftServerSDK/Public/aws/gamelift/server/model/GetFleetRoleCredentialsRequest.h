        ...
        namespace Server {
            namespace Model {
                ...
                public:
                    ...
                    GetFleetRoleCredentialsRequest(GetFleetRoleCredentialsRequest &&other) noexcept {
                        *this = std::move(other);
                    }

                    GetFleetRoleCredentialsRequest &operator=(
                            const GetFleetRoleCredentialsRequest &other
                    ) = default;
                    ...
                    inline const std::string &GetRoleArn() const {
                        return m_roleArn;
                    }

                    inline void SetRoleArn(const std::string &value) {
                        m_roleArn = value;
                    }

                    inline void SetRoleArn(std::string &&value) {
                        m_roleArn = std::move(value);
                    }

                    inline void SetRoleArn(const char *value) {
                        m_roleArn.assign(value);
                    }
                ...
                public:
                    ...
                    inline const char *GetRoleArn() const {
                        return m_roleArn;
                    }
                    ...
                    inline const char *GetRoleSessionName() const {
                        return m_roleSessionName;
                    }
