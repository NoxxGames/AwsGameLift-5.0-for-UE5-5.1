...
namespace Model {
    ...
    public:
        ...
        ServerParameters(const std::string& websocketUrl, const std::string& authToken, const std::string& fleetId,
                const std::string &hostId, const std::string &processId)
                : m_webSocketUrl(websocketUrl), m_authToken(authToken), m_fleetId(fleetId), m_hostId(hostId),
                m_processId(processId) {}

        inline const std::string& GetWebSocketUrl() const {
        ...
        inline const std::string& GetFleetId() const {
            return m_fleetId;
        }

        inline const std::string& GetProcessId() const {
            return m_processId;
        }
        ...
        inline void SetFleetId(const std::string& fleetId) {
            m_fleetId = fleetId;
        }
        ...
        inline void SetHostId(const std::string& hostId) {
            m_hostId = hostId;
        }
    ...
    public:
        ...
        ServerParameters(const char* webSocketUrl, const char* authToken, const char* fleetId,
                const char* hostId, const char* processId)
        {
        ...
        inline const char* GetWebSocketUrl() const {
            return m_webSocketUrl;
        }

        inline const char* GetAuthToken() const {
            return m_authToken;
        }

        inline const char* GetFleetId() const {
            return m_fleetId;
        }

        inline const char* GetProcessId() const {
            return m_processId;
        }

        inline const char* GetHostId() const {
            return m_hostId;
        }
