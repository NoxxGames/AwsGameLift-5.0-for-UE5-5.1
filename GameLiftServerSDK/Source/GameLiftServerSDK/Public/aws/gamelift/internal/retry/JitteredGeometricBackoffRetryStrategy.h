...
namespace Internal {
    ...
    public:
        JitteredGeometricBackoffRetryStrategy()
                : m_maxRetries(DEFAULT_MAX_RETRIES), m_initialRetryIntervalMs(DEFAULT_INITIAL_RETRY_INTERVAL_MS),
                  m_retryFactor(DEFAULT_RETRY_FACTOR), m_minRetryDelayMs(DEFAULT_MIN_RETRY_DELAY_MS) {}
