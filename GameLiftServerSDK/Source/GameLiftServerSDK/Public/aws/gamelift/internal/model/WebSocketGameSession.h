...
namespace Internal {
    ...
    public:
        ...
        inline void SetMaximumPlayerSessionCount(const int maximumPlayerSessionCount) {
        ...
        inline void SetGameProperties(const std::map<std::string, std::string>& gameProperties) {
