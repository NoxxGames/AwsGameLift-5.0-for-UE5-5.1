...
namespace Internal {
    ...
    /**
     * UpdatePlayerSessionCreationPolicyRequest Request. This request is sent to the GameLift WebSocket during a DescribePlayerSessions call
     */
    ...
    public:
        ...
        inline const WebSocketPlayerSessionCreationPolicy& GetPlayerSessionCreationPolicy() const {
