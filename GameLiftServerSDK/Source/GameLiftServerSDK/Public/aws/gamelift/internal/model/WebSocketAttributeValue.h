...
namespace Internal {
    ...
    public:
        ...
        inline const std::string& GetS() const {
            return m_S;
        }

        inline void SetS(const std::string& s) {
            m_S = s;
        }
        ...
        inline const double& GetN() const {
            return m_N;
        }

        inline void SetN(const double& n) {
            m_N = n;
        }
        ...
        inline const std::vector<std::string>& GetSL() const {
            return m_SL;
        }

        inline void SetSL(const std::vector<std::string>& sl) {
            m_SL = sl;
        }
        ...
        inline const std::map<std::string, double>& GetSDM() const {
            return m_SDM;
        }

        inline void SetSDM(const std::map<std::string, double>& sdm) {
            m_SDM = sdm;
        }
