...
namespace Aws {
    namespace GameLift {
        namespace Internal {
            ...
            public:
                static Server::Model::GetFleetRoleCredentialsResult convert(
                        const WebSocketGetFleetRoleCredentialsResponse *webSocketResponse
                );

                static WebSocketGetFleetRoleCredentialsRequest convert(
                        const Server::Model::GetFleetRoleCredentialsRequest &request
                );
            };
        }
    }
