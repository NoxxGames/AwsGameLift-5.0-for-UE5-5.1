...
namespace Internal {
    ...
    /**
     * ActivateServerProcess Request. This request is sent to the GameLift WebSocket during the ProcessReady call
     */
    class ActivateServerProcessRequest : public Message
    {
    public:
        ActivateServerProcessRequest();
        ActivateServerProcessRequest(std::string sdkVersion, std::string sdkLanguage, int port,
        ...
        inline const std::string& GetSdkVersion() const {
            return m_sdkVersion;
        }

        inline const std::string& GetSdkLanguage() const {
            return m_sdkLanguage;
        }
        ...
        inline void SetLogParameters(const Aws::GameLift::Server::LogParameters& logParameters) {
        ...
        inline ActivateServerProcessRequest& WithLogParameters(
                const Aws::GameLift::Server::LogParameters& logParameters) {
