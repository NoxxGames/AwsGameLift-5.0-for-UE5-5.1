...
namespace Internal {
    ...
    /**
     * Base Message class representing a message that is sent to and from the GameLift WebSocket. All messages have
     * a request ID, which represents the following:
     * - For outgoing messages: A randomly generated ID
     * - For incoming messages: The ID of the outgoing message which triggered the incoming messages/response
     */
    ...
    protected:
         ...
         * Subclasses of Message should override this function in order to allow for polymorphic serialization.
         */
        virtual bool Serialize(rapidjson::Writer<rapidjson::StringBuffer>* writer) const;

        /**
         * Given RapidJson Value deserialize and populate this message's member variables.
         * Subclasses of Message should override this function in order to allow for polymorphic deserialization.
         */
