...
namespace Internal {
    ...
    public:
        ...
        static void WriteNonEmptyString(rapidjson::Writer<rapidjson::StringBuffer>* writer, const char* key,
        ...
        static Aws::GameLift::Server::LogParameters SafelyDeserializeLogParameters(const rapidjson::Value& value,
                const char* key);
        static void WriteLogParameters(rapidjson::Writer<rapidjson::StringBuffer>* writer, const char* key,
